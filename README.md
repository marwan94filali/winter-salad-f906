...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/winter-salad-f906
```

A live public deployment of this template is available at [https://winter-salad-f906.templates.workers.dev](https://winter-salad-f906.templates.workers.dev)
